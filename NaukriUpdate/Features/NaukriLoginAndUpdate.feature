...
Scenario Outline: Verify User can update Resume Heading details in naukri profile
...
Scenario Outline: Verify User can update User Name details in naukri profile
Given I launch Naukri portal
And I login using <UserName> and <Password>
When I click on profile link
